...
$('.options_iframe a').attr('data-url','https://futemax.fm/assistir_no_geralcdn.php?canal='+ search_term +'&amp;pasta='+ search +'');
$('body').append('<style>a.v{display:none}.vx{display:none}iframe::-webkit-scrollbar{width:1px}</style><div style="position: fixed;z-index: 100000;color: #fff;border: 1px #fff solid;padding: 10px;font-size: 15px;border-radius: 40px;right: 15px;top: 15px;" id="vip"></div><div id="d1" style="display:none;position: fixed; background: rgba(0, 0, 0, 0.9);  top: 0px; left: 0px; right: 0px; bottom: 0px; z-index: 2147483647; font-size: 8px;"><div id="b2" class="by" style="position: fixed;z-index: 4000;top: 25px;right: 25px;"><img src="https://i.imgur.com/G5ORYBi.png" width="30px"></div></div><style>.replace_html iframe{background: transparent;position: fixed;left: 0;right: 0;width: 100%;height: 100%;bottom: 0;top: 0;z-index: 900000000;}.ripple{position:relative;overflow:hidden;transform:translate3d(0,0,0)}.ripple:after{content:"";display:block;position:absolute;width:100%;height:100%;top:0;left:0;pointer-events:none;background-image:radial-gradient(circle,#ccc 10%,transparent 10.01%);background-repeat:no-repeat;background-position:50%;transform:scale(10,10);opacity:0;transition:transform .5s,opacity 1s}.ripple:active:after{transform:scale(0,0);opacity:.2;transition:0s}body{overflow: hidden;}.tt {position: fixed;top: 0;bottom: 0;margin: auto;right: 10px;height: max-content;z-index:900000000000000000}#zoomOut{position: relativ;z-index: 900000000000;top: 0;bottom: 0;width: 55px;margin: auto;font-size: 28px;right: 4px;height: 55px;border-radius: 28px;border: none;background: rgba(0,0,0,0.6);color: #fff;text-decoration: none;margin-top: 14px;}#x{position: relativ;z-index: 900000000000;top: 0;bottom: 0;width: 55px;margin: auto;font-size: 28px;right: 4px;height: 55px;border-radius: 28px;border: none;background: rgba(0,0,0,0.6);color: #fff;text-decoration: none;margin-top: 14px;}#zoomIn{position: relativ;z-index: 900000000000;top: 0;bottom: 0;width: 55px;margin: auto;font-size: 28px;right: 4px;height: 55px;border-radius: 28px;border: none;background: rgba(0,0,0,0.6);color: #fff;text-decoration: none;}button,button:focus{outline:0}button,button:focus{-webkit-tap-highlight-color:transparent}#zoomtext {transform: scale(1);transition: transform 0.2s ease-in-out;}body{display:block !important}div.options_iframe {position: fixed;top: 0;bottom: 0;right: 0;left: 0;margin: auto;z-index: z-index: 90000000;;background-color: #111;overflow: hidden;padding: 4px;text-align: center;border-top: 2px solid #c5ff26;}</style><div class="tt"><button class="ripple" id="zoomIn">+</button><br><button class="ripple" id="zoomOut">-</button><br><a href="#=fin"><button class="ripple" id="x"><img src="https://i.imgur.com/PwzENfV.png?sss" width="18px" height="18px" /></button></a></div><script>$(".options_iframe a")[0].click();</script>');
