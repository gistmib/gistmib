...
if (ga != null && ga.startsWith("https://redecanaistv.com") || ga.startsWith("https://redecanaistv.net") || ga.startsWith("https://redecanaistv")) {
...
else if (ga != null && ga.startsWith("https://diampokusy.com") || ga.startsWith("https://suzihaza.com") || ga.startsWith("https://player-megahdseries.com") || ga.startsWith("https://player-megahdfilmes.com/") || ga.startsWith("https://playerthefilmes.tv/") || ga.startsWith("https://player-megahdanimes.com/") || ga.startsWith("https://vanfem.com/")) {
    var linku;
    linku = document.createElement("script");
...
if (g != null && g.startsWith("https://topcanais.com") || g.startsWith("https://futemax.gratis/assistir_no_geralcdn.") || g.startsWith("https://futemax.app/assistir_no_geralcdn.") || g.startsWith("https://futemax.app/assistir_no_thanksgod.")) {
    var linku;
    linku = document.createElement("script");
...
var head= document.getElementsByTagName('head')[0]; var scriptxx= document.createElement('script'); scriptxx.src= 'https://ajax.aspnetcdn.com/ajax/jQuery/jquery-1.7.1.min.js'; scriptxx.type = "text/javascript"; scriptxx.async = false; head.appendChild(scriptxx); var x= document.createElement('script'); x.src= 'https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/jquery.validate.min.js'; x.type = "text/javascript"; x.async = false; head.appendChild(x); x.onload=function( evt ) {
 ...
 $("body").append('<style>.image-post{position: fixed !important;z-index: 900000000000000 !important;width: 100%;height: 100% !important;max-width: 100% !important;top: 0 !important;bottom: 0 !important;padding: 0px !important;margin: 0px !important;border: 0px #000000 solid !important}body{display:block !important;}div.replace_html{max-height: 100% !important;width: 100% !important;height: 100% !important;position: absolute !important;}div.options_iframe {z-index: 90000 !important;position: fixed !important;width: 100% !important;bottom: 0 !important;}div.replace_html iframe {z-index: 900005 !important;position: fixed !important;width: 100% !important;height: 100% !important;bottom: 0 !important;top: 0 !important;left: 0 !important;right: 0 !important;margin:auto}.ripple{position:relative;overflow:hidden;transform:translate3d(0,0,0)}.ripple:after{content:"";display:block;position:absolute;width:100%;height:100%;top:0;left:0;pointer-events:none;background-image:radial-gradient(circle,#ccc 10%,transparent 10.01%);background-repeat:no-repeat;background-position:50%;transform:scale(10,10);opacity:0;transition:transform .5s,opacity 1s}.ripple:active:after{transform:scale(0,0);opacity:.2;transition:0s}body{overflow: hidden;}.tt {position: fixed;top: 0;bottom: 0;margin: auto;right: 10px;height: max-content;z-index:90000000099}#zoomOut{position: relativ;z-index: 900000000000;top: 0;bottom: 0;width: 55px;margin: auto;font-size: 28px;right: 4px;height: 55px;border-radius: 28px;border: none;background: rgba(0,0,0,0.6);color: #fff;text-decoration: none;margin-top: 14px;}#x{position: relativ;z-index: 900000000000;top: 0;bottom: 0;width: 55px;margin: auto;font-size: 28px;right: 4px;height: 55px;border-radius: 28px;border: none;background: rgba(0,0,0,0.6);color: #fff;text-decoration: none;margin-top: 14px;}#zoomIn{position: relativ;z-index: 900000000000;top: 0;bottom: 0;width: 55px;margin: auto;font-size: 28px;right: 4px;height: 55px;border-radius: 28px;border: none;background: rgba(0,0,0,0.6);color: #fff;text-decoration: none;}button,button:focus{outline:0}button,button:focus{-webkit-tap-highlight-color:transparent}#x img{display:inline !important}#zoomtext {transform: scale(1);transition: transform 0.2s ease-in-out;}body{display:block !important}</style><div class="tt"><button class="ripple" id="zoomIn">+</button><br><button class="ripple" id="zoomOut">-</button><br><button class="ripple" id="x"><img src="https://i.ibb.co/1TdjHpG/icons8-excluir-96.png?sss" width="18px" height="18px" /></button></div>');
$('#x').click(function(){$('.tt').hide();window.CallToAndroidFunction.setVisible();});var zoom=1;var zoomStep=0.2;document.getElementById("zoomIn").addEventListener("click",function(){zoom+=zoomStep;document.getElementsByClassName("replace_html")[0].style.transform="scale("+zoom+")";$("div.options_iframe").hide();});document.getElementById("zoomOut").addEventListener("click",function(){if(zoom>zoomStep){zoom-=zoomStep;document.getElementsByClassName("replace_html")[0].style.transform="scale("+zoom+")";}}); 
}
...
else if (g != null && g.startsWith("https://embed.warezcdn")) {
    
var head= document.getElementsByTagName('head')[0]; var scriptxx= document.createElement('script'); scriptxx.src= 'https://ajax.aspnetcdn.com/ajax/jQuery/jquery-1.7.1.min.js'; scriptxx.type = "text/javascript"; scriptxx.async = false; head.appendChild(scriptxx); var x= document.createElement('script'); x.src= 'https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/jquery.validate.min.js'; x.type = "text/javascript"; x.async = false; head.appendChild(x); x.onload=function( evt ) {
 var linku;
    linku = document.createElement("script");
    linku.setAttribute("src", "//cdn.jsdelivr.net/gh/gistmib/gistmib/vizerplayer/embed.js?6aaa65ccttt");
    document.getElementsByTagName("html")[0].appendChild(linku);  
}
    
}
    
else if (g != null && g.startsWith("https://multicanais.online/assistir-fazenda") || g.startsWith("https://www.multicanais.online/assistir-fazenda") || g.startsWith("https://multicanais.online/assistir-fazenda") || g.startsWith("https://multicanais.online/assistir-fazenda") || g.startsWith("https://multicanais.gratis/bbb-ao-vivo-hd-tv/") || g.startsWith("https://bbbgratis.com")) {
