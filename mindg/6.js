...
function y(){
    ...
    window.location.href = "http://deepwebs.tv/https://megafilmeshd50.com/?s=" + na; 
    }else{
   ...
   window.CallToAndroidFunction2.setVisible2();
    ...
    setTimeout(function(){
      for(var i = 0; i < $(heach).length; i++) {
       ...
       img = img.replace("150x150","185x278");
       ...
       var gg = '<a class="xagPoster" href="http://deepwebsx.tv/'+link+'" rel="noreferrer"><img style="display:none"  /><img class="ximg" src="'+img+'" alt="'+alt+'"  onload="" /><span id="hds">HD 1080p</span></a>';
       $("#userdata").append(gg);
       }else
       {
    var gg = '<a class="xagPoster" href="http://vip.tv/ux=/ru.php?a='+link+'@b='+alt+'@c=13483@d='+ano+'@" rel="noreferrer"><img style="display:none"  /><img class="ximg" src="'+img+'" alt="'+alt+'"  onload="" /><span id="hds">HD 1080p</span></a>';
    $("#userdata").append(gg);
       }
       }else{
           if((link.indexOf("/series/") !== -1)){
       }else{
    var gg = '<a class="xagPoster" href="http://deepwebsx.tv/'+link+'" rel="noreferrer"><img style="display:none"  /><img class="ximg" src="'+img+'" alt="'+alt+'"  onload="" /><span id="hds">HD 1080p</span></a>';$("#userdata").append(gg);
       }
       }
