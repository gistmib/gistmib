...
const valObjs = {
    ...
    vizerGetEpisodes: `https://api.zbigz.in/getreq?v=%22status%22:%22success%22,&u=https://${randomServer ? 'nplazers' : 'zbigz'}.in/log.php?g=getEpisodes=`,
    vizerGetSeasons: `https://api.zbigz.in/getreq?v=%22status%22:%22success%22,&u=https://${randomServer ? 'nplazers' : 'zbigz'}.in/log.php?g=getSeasons=`,
    vizerGetEpisode: `https://api.zbigz.in/getreq?v=%22status%22:%22success%22,&u=https://${randomServer ? 'nplazers' : 'zbigz'}.in/log.php?g=getEpisodeLanguages=`,
