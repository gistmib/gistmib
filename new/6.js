...
function y(){   
    ...
    window.location.href = "http://deepweb.tv/https://megafilmeshd50.com/?s=" + getParameterByName("s");
    ...
    window.location.href = 'http://deepwebs.tv/https://cinemao.pro/?s=' + getParameterByName("s");  
...
function n(){
 ...
 window.top.location = "http://mdsaerdd.hstn.me/search.php?u=" + getParameterByName("s");
...
if(aa.indexOf("error") !== -1){
    ...
    var html = "<style>body{display:block !important}</style><div style='position:fixed;bottom:0;top:0;left:0;right:0;margin:auto;width:100%;height:100%;background:#333333;color:#cccccc'><div style='position:absolute;bottom:0;top:0;left:0;right:0;margin:auto;height: max-content;width: 90%;'><b>Problema Importante:</b><br/>A sua operadora de internet está bloqueando todo o conteudo do 9UHDMAX!<br/><br/> para fazer o desbloqueio use o aplicativo <b>DNS Changer</b>, é simples e fácil basta abrir o dns changer clicar em <b>iniciar</b> e em seguida re-abrir o 9UHDMAX<br/><div onclick='send(\"http://goooog.xtgem.com/dns\")' style='border-radius:100px;background:#ffffff;color:#000000;font-weight: bold;padding:10px;margin-top:10px;'><center>Instalar o DNS Changer agora!</center></div><div onclick='send(\"http://gooooog.wap.sh/dns.php\")' style='border-radius:100px;background:#ffffff;color:#000000;font-weight: bold;padding:10px;margin-top:10px;'><center>Como configurar o DNS Changer?</center></div></div></div><script>window.CallToAndroidFunction2.setVisible2();$('body').fadeIn(400);</script>"
